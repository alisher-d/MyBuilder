...
import uz.texnopos.mybuilder.databinding.ItemBuilderCardBinding
import uz.texnopos.mybuilder.models.JobModel

class JobListAdapter:RecyclerView.Adapter<JobListAdapter.ItemViewHolder>() {
    inner class ItemViewHolder(val item:ItemBuilderCardBinding):RecyclerView.ViewHolder(item.root){
...
var models= mutableListOf<JobModel>()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val bind=ItemBuilderCardBinding.inflate(LayoutInflater.from(parent.context),parent,false)
